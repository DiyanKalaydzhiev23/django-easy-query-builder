...
class QueryBuilderAdminMixin:
    ...
    def get_query_builder_fields_mapping(self: QueryBuilderModelAdminMixinProtocol):
        """
    ...
    @csrf_protect_m
    def changelist_view(self: QueryBuilderModelAdminMixinProtocol, request: HttpRequest, extra_context: dict=None):
